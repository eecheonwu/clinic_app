...
graph TB
    ...
    subgraph API [FastAPI Backend Container]
        subgraph Routers [API Route Controllers]
            AuthRouter[Auth & Verification Router - Staff/OTP]
            PatientAuthRouter[Patient Auth Router - Email/Password]
        ...
        subgraph Services [Business Logic & Services]
            ...
            PatientAuthService[Patient Auth Service]
            EmailVerification[Email Verification Engine]
    ...
    PatientAuthRouter --> PatientAuthService
    PatientAuthRouter --> EmailVerification
    PatientAuthService --> AuthService
    PatientAuthService --> EmailVerification
    PatientAuthService --> NotificationService
    ...
    EmailVerification -->|Manage Verification Tokens| PostgreSQL
