...
| Email Provider (SMTP/SendGrid/SES) | Auth emails & verification links | SMTP / REST API (Outbound) |
...
- CMP → WhatsApp, Termii, Infobip, Email Provider (outbound notifications via async workers)
...
graph TB
    ...
    Email["Email Provider\nAuth emails & verification links"]
    ...
    CMP -->|Sends verification emails| Email
